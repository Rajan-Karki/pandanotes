                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($select_users) > 0) {
                                    while ($row = mysqli_fetch_array($select_users)) {
                                        ...
                                        echo "<td><a class='delete-link' onClick=\"javascript: return confirm('Are you sure you want to delete this user?')\" href='users.php?delete=$user_id'><i class='fa fa-times fa-lg'></i> delete</a></td>";
                                        echo "</tr>";
                                    }
                                }
                                ?>
                        ...
                        if (isset($_GET['delete'])) {
                            ...
                            if ($id1 == 'admin') {
                                ...
                                if (mysqli_affected_rows($conn) > 0) {
                                    ...
                                    echo "<script>alert('Error occurred while deleting user.'); window.location.href= 'users.php';</script>";
                                }
                            }
                        }
                        ?>
